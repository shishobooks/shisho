...
├── e2e/theme.spec.ts        # Browser checks for theme contrast and responsive chrome
├── src/
...
- **Theme checks**: `website/e2e/theme.spec.ts` covers control contrast, the mobile drawer background, and the dark-only invariant
